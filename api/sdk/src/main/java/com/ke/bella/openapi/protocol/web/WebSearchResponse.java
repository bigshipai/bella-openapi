...
/**
 * Web Search Response based on Tavily Search API Contains search results,
 * answer, images, and metadata from web search
 */
@Data
@SuperBuilder
@NoArgsConstructor
public class WebSearchResponse extends OpenapiResponse {
    ...
    /**
     * The search query that was executed (required) Example: "Who is Leo
     * Messi?"
     */
    private String query;

    /**
     * A short answer to the user's query, generated by an LLM (required)
     * Included in the response only if include_answer is requested (i.e., set
     * to
     * true, basic, or advanced) Example: "Lionel Messi, born in 1987, is an
     * Argentine footballer widely regarded as one of the greatest players of
     * his generation..."
     */
    @Nullable
    ...
    /**
     * List of query-related images (required) If include_image_descriptions is
    ...
    /**
     * A dictionary of the selected auto_parameters, only shown when
     * auto_parameters is true Example: {"topic": "general", "search_depth":
     * "basic"}
     */
    @Nullable
    ...
    public static class SearchResult implements Serializable {
        ...
        /**
         * The title of the search result Example: "Lionel Messi Facts |
         * Britannica"
         */
        private String title;

        /**
         * The URL of the search result Example:
         * "https://www.britannica.com/facts/Lionel-Messi"
         */
        private String url;

        /**
         * A short description of the search result Example: "Lionel Messi, an
         * Argentine footballer, is widely regarded..."
         */
        ...
        /**
         * The favicon URL for the result Example:
