...
import com.ke.bella.openapi.domain.protocol.message.MessageRequest;
...
public class AwsCompletionConverter {
    ...
    public static CompletionResponse convert2OpenAIResponse(ConverseResponse response) {
        ...
        com.ke.bella.openapi.domain.protocol.completion.Message openAiMsg = new com.ke.bella.openapi.domain.protocol.completion.Message();
    ...
    public static StreamCompletionResponse convert2OpenAIStreamResponse(ContentBlockStart response, int toolIndex) {
        ...
        if(response.toolUse() != null) {
            com.ke.bella.openapi.domain.protocol.completion.Message.ToolCall toolCall = new com.ke.bella.openapi.domain.protocol.completion.Message.ToolCall();
            ToolUseBlockStart toolUseBlock = response.toolUse();
            toolCall.setType("function");
            toolCall.setId(toolUseBlock.toolUseId());
            com.ke.bella.openapi.domain.protocol.completion.Message.FunctionCall fc = new com.ke.bella.openapi.domain.protocol.completion.Message.FunctionCall();
    ...
    private static List<com.ke.bella.openapi.domain.protocol.completion.Message.ToolCall> convert2OpenAIToolCall(List<ContentBlock> contentBlocks) {
        List<com.ke.bella.openapi.domain.protocol.completion.Message.ToolCall> toolCalls = new ArrayList<>();
        int index = 0;
    ...
    private static com.ke.bella.openapi.domain.protocol.completion.Message.ToolCall convert2OpenAIToolCall(ToolUseBlock toolUseBlock, int index) {
        com.ke.bella.openapi.domain.protocol.completion.Message.ToolCall toolCall = new com.ke.bella.openapi.domain.protocol.completion.Message.ToolCall();
        toolCall.setId(toolUseBlock.toolUseId());
        toolCall.setType("function");
    ...
    private static Pair<List<SystemContentBlock>, List<Message>> generateMsg(List<com.ke.bella.openapi.domain.protocol.completion.Message> openAIMsgList,
        ...
        for (com.ke.bella.openapi.domain.protocol.completion.Message message : openAIMsgList) {
    ...
    private static List<SystemContentBlock> convert2AwsSystemContent(com.ke.bella.openapi.domain.protocol.completion.Message openAiMsg,
                                                                     AwsProperty property) {
    ...
    private static List<ContentBlock> convert2AwsContent(com.ke.bella.openapi.domain.protocol.completion.Message message, AwsProperty property) {
        ...
        if(message.getRole().equals("tool")) {
            ...
            if(message.getTool_calls() != null && !message.getTool_calls().isEmpty()) {
                for (com.ke.bella.openapi.domain.protocol.completion.Message.ToolCall toolCall : message.getTool_calls()) {
    ...
    private static ToolConfiguration convert2AwsTool(List<com.ke.bella.openapi.domain.protocol.completion.Message.Tool> tools, Object toolChoice) {
        List<software.amazon.awssdk.services.bedrockruntime.model.Tool> list = new ArrayList<>();
        for (com.ke.bella.openapi.domain.protocol.completion.Message.Tool tool : tools) {
    ...
    private static software.amazon.awssdk.services.bedrockruntime.model.Tool convert2AwsTool(
            com.ke.bella.openapi.domain.protocol.completion.Message.Tool tool) {
