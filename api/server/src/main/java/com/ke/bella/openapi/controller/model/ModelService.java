...
import com.ke.bella.openapi.jooqgen.tables.pojos.ModelEndpointRelDB;
...
import static com.ke.bella.openapi.controller.console.MetadataValidator.generateInvalidModelJsonKeyMessage;
import static com.ke.bella.openapi.controller.console.MetadataValidator.json2Map;
import static com.ke.bella.openapi.controller.console.MetadataValidator.matchPath;
...
public class ModelService {
    ...
    private void checkJson(String jsonStr, String field, List<String> basisEndpoints) {
        ...
        Assert.isTrue(map != null && !map.isEmpty(), field + " not in JSON format");
    ...
    private void doModelLink(MetaDataOps.ModelLinkOp op) {
        ...
        Assert.isTrue(db != null, "Entity does not exist");
        ...
        if(StringUtils.isNotEmpty(op.getLinkedTo())) {
            ...
            Assert.isTrue(CollectionUtils.isNotEmpty(path), "linkTo entity does not exist");
            Assert.isTrue(!path.contains(op.getModelName()), "Circular dependency detected");
    ...
    public ModelDetails getModelDetails(String modelName) {
        ...
        Assert.notNull(model, "Entity does not exist");
