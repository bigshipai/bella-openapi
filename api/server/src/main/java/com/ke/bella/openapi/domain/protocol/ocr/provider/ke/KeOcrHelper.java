package com.ke.bella.openapi.domain.protocol.ocr.provider.ke;
...
public class KeOcrHelper {
    ...
    public ApiResponse.OpenapiError buildError(KeResponse keResponse) {
        int code = keResponse.getCode();
        int httpCode = determineHttpCode(code);

        return ApiResponse.OpenapiError.builder()
