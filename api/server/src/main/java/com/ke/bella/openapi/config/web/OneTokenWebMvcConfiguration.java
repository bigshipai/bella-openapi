...
import com.ke.bella.openapi.config.interceptor.AuthorizationInterceptor;
import com.ke.bella.openapi.config.interceptor.ConcurrentStartInterceptor;
import com.ke.bella.openapi.config.interceptor.MonthQuotaInterceptor;
import com.ke.bella.openapi.config.interceptor.QpsRateLimitInterceptor;
...
public class OneTokenWebMvcConfiguration implements WebMvcConfigurer {
	...
	public OneTokenWebMvcConfiguration(
