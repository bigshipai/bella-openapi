package com.ke.bella.openapi.config.client;
...
import com.ke.bella.openapi.utils.Okhttp3Interceptor;
...
public class OpenAiServiceFactory {
    ...
    public OpenAiService create(int connectTimeoutSeconds, int readTimeoutSeconds) {
        ...
        OkHttpClient client = new OkHttpClient.Builder()
                .addInterceptor(new Okhttp3Interceptor(oneTokenApiProperties.getHost(), OneTokenContext.snapshot()))
