package com.ke.bella.openapi.domain.endpoint;
...
import com.ke.bella.openapi.domain.endpoint.enums.MetadataFeatures;
import com.ke.bella.openapi.controller.endpoint.dto.Condition;
import com.ke.bella.openapi.controller.meta.dto.EndpointDetails;
...
import static com.ke.bella.openapi.common.constant.EntityConstants.INNER;
import static com.ke.bella.openapi.common.constant.EntityConstants.MAINLAND;
import static com.ke.bella.openapi.common.constant.EntityConstants.OVERSEAS;
import static com.ke.bella.openapi.common.constant.EntityConstants.PROTECTED;
...
import com.ke.bella.openapi.domain.endpoint.repo.EndpointRepo;
...
import com.ke.bella.openapi.common.dto.TypeSchema;
...
//            + "&& (#condition.features == null || #condition.features.isEmpty())")
    ...
    private void checkCostScript(MetaDataOps.EndpointOp op) {
        ...
        try {
            ...
            Assert.isTrue(cost.doubleValue() > 0, "Script returned unexpected result, result is " + result);
        } catch (Exception e) {
            throw new BizParamCheckException("Script returned unexpected result, result is " + result.toString());
        }
    }
