...
public class ImagesRequest implements UserRequest, Serializable, IMemoryClearable {
     ...
     * characters for gpt-image-1, 1000 characters for dall-e-2 and 4000
     ...
     * transparent, opaque or auto (default value).
     */
    @Nullable
     ...
     * is only supported for gpt-image-1 with the webp or jpeg output formats,
     * and defaults to 100.
     */
    @Nullable
    ...
    /**
     * 火山协议：随机数种子，用于控制模型生成内容的随机性。取值范围为 [-1,
     * 2147483647]。如果不提供，则算法自动生成一个随机数作为种子。如果希望生成内容保持一致，可以使用相同的 seed 参数值。
     */
    private Integer seed;

    /**
     * 火山协议：模型输出结果与prompt的一致程度，即生成图像的自由度；值越大，模型自由度越小，与用户输入的提示词相关性越强。取值范围：[1, 10]
     * 之间的浮点数。
     */
