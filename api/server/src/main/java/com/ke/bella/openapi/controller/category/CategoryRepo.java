package com.ke.bella.openapi.controller.category;

import com.ke.bella.openapi.domain.common.Page;
import com.ke.bella.openapi.domain.common.StatusRepo;
...
import com.ke.bella.openapi.jooqgen.tables.records.CategoryRecord;
...
import static com.ke.bella.openapi.jooqgen.Tables.ENDPOINT_CATEGORY_REL;
import static com.ke.bella.openapi.jooqgen.tables.Category.CATEGORY;
...
public class CategoryRepo extends StatusRepo<CategoryDB, CategoryRecord, String> {
    ...
    protected CategoryRecord getRecForInsert(Object op) {
        ...
        try {
            ...
            throw new RuntimeException("Invalid parameter, missing parentCode");
        }
        return rec;
    }
    ...
    private String generateCategoryCode(String parentCode) {
        ...
        Assert.isTrue(!maxCode.equals("9999"), "Category exceeds maximum limit");
