...
public class ChannelDB implements Serializable {
    ...
    /**
     * Getter for <code>channel.data_destination</code>.
    ...
    /**
     * Setter for <code>channel.data_destination</code>.
     * 数据流向(inner/mainland/overseas)
     */
    ...
    /**
     * Getter for <code>channel.queue_mode</code>.
    ...
    /**
     * Setter for <code>channel.queue_mode</code>.
     * 队列模式(0:无队列;1:pull模式;2:route模式;3:pull+route模式)
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ChannelDB other = (ChannelDB) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
