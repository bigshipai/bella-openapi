...
import com.ke.bella.openapi.domain.protocol.metrics.MetricsResolver;
...
public class CompletionMetricsResolver implements MetricsResolver {
    ...
    private boolean canResolve(ApiResponse response, String supplier) {
    ...
    public Integer resolveUnavailableSeconds(EndpointProcessData processData) {
        ApiResponse response = processData.getResponse();
        int seconds = 1;
