...
import com.ke.bella.openapi.domain.protocol.asr.TencentProperty;
import com.ke.bella.openapi.domain.protocol.asr.TencentRealTimeAsrRequest;
import com.ke.bella.openapi.domain.protocol.asr.TencentRealTimeAsrResponse;
import com.ke.bella.openapi.domain.protocol.asr.TencentStreamAsrCallback;
...
public class TencentAdaptor implements RealTimeAsrAdaptor<TencentProperty> {
    ...
    public WebSocket startTranscription(String url, TencentProperty property, RealTimeMessage request, Callbacks.WebSocketCallback callback) {
        ...
        // 建立WebSocket连接
        WebSocket webSocket = HttpUtils.websocketRequest(wsRequest, new BellaWebSocketListener(callback));
        callback.started();
        return webSocket;
    }
