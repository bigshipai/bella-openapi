package com.ke.bella.openapi.modules.login.config;

import com.ke.bella.openapi.common.model.Operator;
import com.ke.bella.openapi.modules.login.LoginProperties;
import com.ke.bella.openapi.modules.login.SessionAuthFilter;
import com.ke.bella.openapi.modules.login.oauth.OAuthProperties;
import com.ke.bella.openapi.modules.login.oauth.providers.GithubOAuthService;
import com.ke.bella.openapi.modules.login.oauth.providers.GoogleOAuthService;
import com.ke.bella.openapi.modules.login.session.RedisSessionManager;
import com.ke.bella.openapi.modules.login.session.SessionManager;
import com.ke.bella.openapi.modules.login.session.SessionProperty;
...
public class OneTokenLoginConfiguration {
    ...
    @Bean
    public FilterRegistrationBean<SessionAuthFilter> sessionAuthFilter(LoginProperties properties, SessionManager sessionManager) {
        FilterRegistrationBean<SessionAuthFilter> registration = new FilterRegistrationBean<>();
        registration.setFilter(new SessionAuthFilter(properties, sessionManager));
