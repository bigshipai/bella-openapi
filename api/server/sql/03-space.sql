...
(
    ...
    `space_code`        varchar(64)   NOT NULL DEFAULT '' COMMENT '空间编码',
    `space_name`        varchar(128)  NOT NULL DEFAULT '' COMMENT '空间名称',
    `space_description` varchar(255)  NOT NULL DEFAULT '' COMMENT '空间描述',
    ...
    `owner_uid`         varchar(64)   NOT NULL DEFAULT '' COMMENT '空间拥有人系统号',
...
(
    `id`         bigint unsigned                                              NOT NULL AUTO_INCREMENT COMMENT '主键',
    `space_code` varchar(64)  NOT NULL DEFAULT '' COMMENT '团队编码',
...
(
    ...
    `space_code`  varchar(64)  NOT NULL DEFAULT '' COMMENT '空间编码',
    `role_code`   varchar(64)  NOT NULL DEFAULT '' COMMENT '角色编码',
    `member_name` varchar(64)  NOT NULL DEFAULT '' COMMENT '成员姓名',
    `member_uid`  varchar(64)  NOT NULL DEFAULT '' COMMENT '成员系统号',
    `status`      tinyint         NOT NULL DEFAULT '0' COMMENT '删除状态(0未删除，-1已删除)',
    `ctime`       datetime        NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
