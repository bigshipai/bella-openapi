...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'ak' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'API Key变更历史表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `apikey_month_cost` VALUES (1, 'ak-bootstrap-admin', '2026-06', 9.2527, '2026-06-03 22:00:28', '2026-06-07 18:22:28');
...
CREATE TABLE `apikey_transfer_log`  (
  ...
  INDEX `idx_ctime`(`ctime` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'API Key所有权转移审计日志表' ROW_FORMAT = Dynamic;
...
-- Records of instance
-- ----------------------------
INSERT INTO `instance` VALUES (1, '192.168.5.106', 8080, 1, '2026-06-03 20:45:31', '2026-06-07 18:13:23');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '模型授权信息' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '空间表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '空间成员信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '空间角色表' ROW_FORMAT = Dynamic;
